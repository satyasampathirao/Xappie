...
public abstract class MaterialButton extends CustomView {
    ...
    protected void setDefaultProperties() {
        // Min size
        setMinimumHeight(DesignUtils.dpToPx(minHeight, getResources()));
        setMinimumWidth(DesignUtils.dpToPx(minWidth, getResources()));
        // Background shape
    ...
    public Bitmap makeCircle() {
        Bitmap output = Bitmap.createBitmap(
                getWidth() - DesignUtils.dpToPx(6, getResources()), getHeight()
                        - DesignUtils.dpToPx(7, getResources()), Config.ARGB_8888);
