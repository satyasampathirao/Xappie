 ...
 * {@link Permissions#showRationaleInDialog(String, String, String, Permissions.IOnRationaleProvided)}.
 */
public class PermissionsDialog extends DialogFragment {
    ...
    /**
     * Creates a new {@link PermissionsDialog}. Only intended to be used by
     * {@link Permissions#showRationaleInDialog(String, String, String, Permissions.IOnRationaleProvided)}.
     ...
     * @return A new {@link PermissionsDialog}.
     */
    public static PermissionsDialog newInstance(@Nullable String title, @NonNull String message, @Nullable String buttonText) {
        PermissionsDialog dialogFragment = new PermissionsDialog();
