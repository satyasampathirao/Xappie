...
public class Permissions {
    ...
    public static String TITLE = "Permission !";
    public static String MESSAGE = "Without this permission the app is unable work " +
            "and some time may cause app crash";
    ...
    public void showRationaleInDialog(@Nullable String title, @NonNull String message, @Nullable String buttonText, @NonNull final IOnRationaleProvided rationaleCallback) {
        PermissionsDialog dialogFragment = PermissionsDialog.newInstance(title, message, buttonText);
        ...
        dialogFragment.setOnCloseListener(new PermissionsDialog.IOnCloseListener() {
            @Override
            public void onClose() {
                rationaleCallback.onRationaleProvided();
            }
        });
        dialogFragment.show(mActivity.getFragmentManager(), PermissionsDialog.TAG);
    }
