...
public class SnackBar {
    ...
    public SnackBar text(String titleText, String actionText, int lines) {
    ...
    public SnackBar setIconForTitle(Drawable titleDrawable, IconPosition iconPosition, int drawablePadding) {
    ...
    public SnackBar setIconForAction(Drawable actionDrawable, IconPosition iconPosition, int drawablePadding) {
